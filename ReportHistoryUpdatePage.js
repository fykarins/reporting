...
import { ReportHistoryUpdateTable } from "./ReportHistoryUpdateTable";
...
export const ReportHistoryUpdatePage = () => {
  ...
  const handleSearch = async () => {
    const params = {
      reportType: "HistoryUpdateMasterData",
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (response.payload.status === 200) {
        ...
        link.download = "Report_History_Update.xlsx";
        link.click();
      } else {
  ...
  return loading ? (
    ...
    <Card>
      <CardHeader title="Report History Update">
        <CardHeaderToolbar>
