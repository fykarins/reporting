...
import { ReportPoScheduleTable } from "./ReportPoScheduleTable";
...
export const ReportPoSchedulePage = () => {
  ...
  const handleSearch = async () => {
    const params = {
      reportType: "PO_DeliverySchedule",
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (response.payload.status === 200) {
        ...
        link.download = "Report_Purchase_Order_Delivery_Schedule.xlsx";
        link.click();
      } else {
        showErrorDialog(response.payload.data.message);
        console.log("else");
  ...
  return loading ? (
    ...
    <Card>
      <CardHeader title="Report Purchase Order Delivery Schedule">
        <CardHeaderToolbar>
