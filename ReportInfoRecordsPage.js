...
import { ReportInfoRecordsTable } from "./ReportInfoRecordsTable";
...
export const ReportInfoRecordsPage = () => {
  ...
  const handleSearch = async () => {
    const params = {
      reportType: "InfoRecords",
      Vendor: filterVendorCode,
  ...
  return loading ? (
    ...
    <Card>
      <CardHeader title="Report Price List">
        <CardHeaderToolbar>
        ...
        <div className="mb-5">
          <Form.Group as={Row}>
            <Col sm={6}>
              ...
              <Form.Group as={Row}>
                <Form.Label column sm={3}>
                  <b>Info Record Number</b>
                </Form.Label>
                <Col sm={6}>
                  <Form.Control
                    type="text"
                    placeholder="Info Record Number"
                    onChange={(e) => {
                      setInfoRecord(e.target.value);
                    }}
                    value={infoRecord}
                    onKeyPress={handleKeyPress}
                  />
