...
import { ReportDealerRequestTable } from "./ReportDealerRequestTable";
...
export const ReportDealerRequestPage = () => {
  ...
  const [startTglPengajuan, setStartTglPengajuan] = useState("");
  const [endTglPengajuan, setEndTglPengajuan] = useState("");
  ...
  const handleSearch = async () => {
    const params = {
      reportType: "DealerRequest",
      Vendor_Code: filterVendorCode,
      Depo: depo,
      Kode_Dealer: kodeDealer,
      start_Tanggal_Pengajuan: startTglPengajuan,
      end_Tanggal_Pengajuan: endTglPengajuan,
    ...
    //--Validasis--//
    if (startTglPengajuan && endTglPengajuan === "") {
      return showErrorDialog("Please Select End Tanggal Pengajuan ");
    }
    if (endTglPengajuan && startTglPengajuan === "") {
      return showErrorDialog("Please Select Start Tanggal Pengajuan");
    }
    //-- --//
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (response.payload.status === 200) {
        ...
        link.download = "Report_Dealer_Request.xlsx";
        link.click();
      } else {
  ...
  return loading ? (
    ...
    <Card>
      <CardHeader title="Report Dealer Request">
        <CardHeaderToolbar>
              ...
              <Form.Group as={Row}>
                ...
                <Col sm={4}>
                  <Form.Control
                    ...
                    sm={6}
                    onChange={(e) => setStartTglPengajuan(e.target.value)}
                    value={startTglPengajuan}
                  />
                </Col>
                ...
                <Col sm={4}>
                  <Form.Control
                    ...
                    sm={6}
                    onChange={(e) => setEndTglPengajuan(e.target.value)}
                    value={endTglPengajuan}
                  />
                </Col>
              </Form.Group>
