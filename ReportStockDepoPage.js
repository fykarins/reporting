...
import { ReportStockDepoTable } from "./ReportStockDepoTable";
...
export const ReportStockDepoPage = () => {
  ...
  return loading ? (
    ...
    <Card>
      <CardHeader title="Report Stock Depo">
        <CardHeaderToolbar>
