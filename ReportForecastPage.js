...
import { ReportForecastTable } from "./ReportForecastTable";
...
export const ReportForecastPage = () => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (response.payload.status === 200) {
        ...
        link.download = "Report_Forecast.xlsx";
        link.click();
      } else {
        showErrorDialog(response.payload.data.message);
        console.log("else");
  ...
  return loading ? (
    ...
    <Card>
      <CardHeader title="Report Forecast">
        <CardHeaderToolbar>
